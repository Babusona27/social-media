...
const Landing = () => {
  ...
  return (
    <>
            ...
            <Box>
              ...
              <Typography href="#"
                ...
                <Box sx={{
                  ...
                  width:"100%",
                  height:"100px",
                }} src={process.env.PUBLIC_URL + "/assets/images/bottom-shadow.png"} component={"img"}/>
            </Box>
          </Box>
        </Container>
      </Box>
      ...
      }} className="features_section" component={"section"}>
         <Container maxWidth="lg" sx={{ height: "100%" }}>
<Typography sx={{
  textAlign:"center",
  fontSize:{
...
<Typography sx={{
  ...
  textAlign:"center",
}} component={"h3"}>Make Friends</Typography>
</Box>
<Box sx={{
  display:"flex",
  alignItems:"center",
...
<Typography sx={{
  ...
  color:theme.palette.primary.LightGray1,
  textAlign:"center",
}} component={"h3"}>Publish Posts</Typography>
</Box>
<Box sx={{
  display:"flex",
  alignItems:"center",
...
<Typography sx={{
  ...
  color:theme.palette.primary.LightGray1,
  textAlign:"center",
}} component={"h3"}>Private Chats</Typography>
</Box>
<Box sx={{
  display:"flex",
  alignItems:"center",
...
<Typography sx={{
  ...
  color:theme.palette.primary.LightGray1,
  textAlign:"center",
}} component={"h3"}>Create Polls</Typography>
</Box>
</Box>
<Box>
  <Typography sx={{
...
People Already Signed Up
  ...
  <Box sx={{
    ...
    width:"823px",
    height:"370px",
  }} component={"img"} src={process.env.PUBLIC_URL+"/assets/images/face-map.png"}/>
  </Box>
...
<Button sx={{
                   ...
                   <Box sx={{
                    width:"150px",
                    height:"45px",
}} src={process.env.PUBLIC_URL + "/assets/images/google-play.png"} component={"img"}/>
                  </Button>
                  <Button sx={{
                    marginBottom:"-20px",
                    color: theme.palette.primary.White,
                   ...
                   <Box sx={{
                    width:"150px",
                    height:"45px",
}} src={process.env.PUBLIC_URL + "/assets/images/app-store.png"} component={"img"}/>
                  </Button>
</Box>
<Typography sx={{
     fontSize:"50px",
...
stay connected anytime, anywhere
  ...
  <Box sx={{
    ...
    width:"780px",
    height:"180px",
  }} component={"img"} src={process.env.PUBLIC_URL+"/assets/images/iphone.png"}/>
  </Box>
</Container>
      </Box>
      <Box sx={{
